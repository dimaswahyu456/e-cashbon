            ...
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="text-muted">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('acc.list') }}" class="btn btn-secondary">Back</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="mt-4">
                        <div class="card-body">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                ...
                                <small class="text-muted">30 Mei 2025 - 10:10</small><br>
                                <em>Tiket Pesawat JKK Book 1254343586</em>
                                </div>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                <div>
                                <strong>Manager Operasional</strong><br>
                                <small class="text-muted">01 Juni 2025 - 15:12</small><br>
                                <em>Silakan lanjut ke bagian keuangan.</em>
                                </div>
                                <span class="badge bg-success rounded-pill">✓ Disetujui</span>
                            </li>
            ...
            @csrf
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="submitBtn" name="status" value="Approved">Simpan</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-dialog">
            ...
            <input type="hidden" name="id_cashbon" value="{{ $id_cashbon }}">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                    <button type="submit" class="btn btn-danger" name="status" value="Rejected">Kirim Penolakan</button>
                    </div>
                </div>
            </form>
        </div>
